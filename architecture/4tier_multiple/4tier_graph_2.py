...
def main():
	...
	sched = march.make_service_sched("CMT", [NGX_THREAD, list(range(20, 20 + NGX_THREAD))], None)
	...
	balance = march.make_serv_inst(servName = "php", servDomain = "", instName = "load_balancer_php",
	...
	for i in range(1, PHP_INST + 1):
		sched = march.make_service_sched("CMT", [PHP_THREAD, list(range(20, 20 + PHP_THREAD))], None)
		...
		services.append(php)
		sched = march.make_service_sched("CMT", [1, [20 + PHP_THREAD]], None)
		inst_name = "php_io_inst_" + str(i - 1)
		php_io = march.make_serv_inst(servName = inst_name, servDomain = "", instName = inst_name, 
	...
	for i in range(1, MONGO_INST + 1):
		sched = march.make_service_sched("CMT", [MONGO_THREAD, list(range(20, 20 + MONGO_THREAD))], None)
		inst_name = "mongodb_inst_" + str(i - 1)
		mongodb = march.make_serv_inst(servName = inst_name, servDomain = "", instName = inst_name, 
			modelName = "mongodb", sched = sched, machId = cur_machine)
		services.append(mongodb)
		sched = march.make_service_sched("CMT", [1, [20 + MONGO_THREAD]], None)
		inst_name = "mongo_io_inst_" + str(i - 1)
		mongodb_io = march.make_serv_inst(servName = inst_name, servDomain = "", instName = inst_name,
