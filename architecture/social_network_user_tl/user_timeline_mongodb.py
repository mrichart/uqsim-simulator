...
def main():
	...
	# mongodb
	user_timeline_mongodb = march.make_micro_service(servType = "micro_service", servName = "user_timeline_mongodb", bindConn = True, paths = [cache_hit_path, cache_miss_path], 
										baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/user_timeline_mongodb.json", "w+") as f:
		json.dump(user_timeline_mongodb, f, indent=2)
