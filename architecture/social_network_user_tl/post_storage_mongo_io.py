...
def main():
	...
	post_storage_mongo_io = march.make_micro_service(servType = "micro_service", servName = "post_storage_mongo_io", bindConn = False, paths = [path], baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/post_storage_mongo_io.json", "w+") as f:
		json.dump(post_storage_mongo_io, f, indent=2)
