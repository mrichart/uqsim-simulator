...
def main():
	...
	# home_timeline_redis
	home_timeline_redis = march.make_micro_service(servType = "micro_service", servName = "home_timeline_redis", bindConn = False, paths = [read_path, write_path], 
										baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/home_timeline_redis.json", "w+") as f:
		json.dump(home_timeline_redis, f, indent=2)
