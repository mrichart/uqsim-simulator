...
def main():
	...
	# mongodb
	post_storage_mongodb = march.make_micro_service(servType = "micro_service", servName = "post_storage_mongodb", bindConn = True, paths = [cache_hit_path, cache_miss_path], 
										baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/post_storage_mongodb.json", "w+") as f:
		json.dump(post_storage_mongodb, f, indent=2)
