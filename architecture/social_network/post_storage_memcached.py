...
def main():
	...
	post_storage_memcached = march.make_micro_service(servType = "micro_service", servName = "post_storage_memcached", bindConn = True, paths = [read_path, write_path], 
		baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/post_storage_memcached.json", "w+") as f:
		json.dump(post_storage_memcached, f, indent=2)
