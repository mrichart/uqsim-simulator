# This file is used to generate the machine.json file for the 4-tier architecture
#
import json
...
def main():
	...
	l2 = march.make_machine_links(0, 2, 0, 100)
	l3 = march.make_machine_links(1, 2, 0, 100)
